  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen text-center p-4">
      ...
      <h1 className="text-6xl font-serif font-bold text-white mb-8">
        Welcome to Private Bills
      </h1>

      {/* Contêiner da imagem e texto lado a lado */}
      <div className="bg-yellow-200 border-2 border-black rounded-lg p-2 shadow-md w-full max-w-7xl flex items-center mb-8">
        {/* Imagem à esquerda */}
        ...
        <div className="w-1/2 text-left p-4">
          ...
          <h2 className="text-lg font-bold text-teal-900 mb-3">
            Join us and transform the way you handle your bills and Bitcoin!
          </h2>
        </div>
      </div>
