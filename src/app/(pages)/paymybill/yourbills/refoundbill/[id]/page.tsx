        ...
        {bill ? (
          <>
            ...
            <button
              ...
              disabled={isPaying}
              className="w-full bg-green-500 text-white font-semibold py-2 px-4 rounded-lg hover:bg-green-600 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
